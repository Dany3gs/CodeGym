...
Para encontrar un elemento en una matriz, necesita una búsqueda binaria. Para hacer esto, use el método static
Arrays.binarySearch(int[], int) de la clase Arrays. El primer parámetro es pasar la matriz ordenada en la que buscar,
 y el segundo parámetro es el elemento que se buscará. El método Arrays.binarySearch(int[], int) devuelve el índice del
 elemento buscado, si dicho elemento está en la matriz.
...
Requisitos:
    ...
    Al llamar al método main(String[]), muestre verdadero en la consola si el valor de la variable del elemento está
